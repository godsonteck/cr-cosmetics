...
export default function ProductCard({ product }: { product: Product }) {
  ...
  const { id, slug, name, brand, price, originalPrice, image, inStock, details } = product;
  ...
  return (
    <div className="product-card">
      <div className="media-box">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill={isWishlisted ? '#2D1820' : 'none'} stroke="#2D1820" strokeWidth="1.8">
        ...
        {product.badge === 'sale' && inStock && <span className="sale-tag">SALE</span>}
      </div>
      ...
      <style jsx>{`
        ...
        .product-card:hover {
          border-color: #2D1820;
          box-shadow: 0 4px 16px rgba(45, 24, 32, 0.08);
        }
